        ...
        <div class="col-md-6 offset-md-3 mt-5">
            <form action="{{Route('productStor')}}" method="POST">                 
                ...
                <div class="form-group">
                    ...
                    <input value="{{ $product->pname }}" type="text" name="pname" id="pname" class="form-control">
                </div>
                <div class="form-group">
                    <label for="pdes">Product Description</label>
                    <input value="{{ $product->pdes }}"type="text" name="pdes" id="pdes"class="form-control">
                </div>
                <div class="form-group">
                    <label for="cat">Product Category</label>
                    <input value="{{ $product->cat }}"type="text" name="cat" id="cat"class="form-control">
                </div>
                <div class="form-group">
                    <label for="scat">Product Sub Category</label>
                    <input value="{{ $product->scat }}"type="text" name="scat" id="scat"class="form-control">
                </div>
                 <div class="form-group">
