               ...
               <form action="{{ route('productStore') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="pdes" class="form-control" name="pdes">
                    </div>
                    <div class="form-group">
                        <label for="cat">Product Category</label>
                        <input type="text" id="cat" class="form-control" name="cat">
                    </div>
                    <div class="form-group">
                        <label for="scat">Product Subcategory</label>
                        <input type="text" id="scat" class="form-control" name="scat">
                    </div>
                    <div class="form-group">
                    ...
                    <button class="mt-3 btn btn-info">Save</button>
               </form>
            </div>
        </div>
    </div>
